"""
Django settings for plugins_41358 project.
...
ROOT_URLCONF = 'plugins_41358.urls'
...
WSGI_APPLICATION = 'plugins_41358.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plugins_41358 API",
    "DESCRIPTION": "API documentation for plugins_41358 App",
    "VERSION": "v1",
}
